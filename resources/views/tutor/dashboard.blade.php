                    ...
                    @foreach($proyectos as $p)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-center">
                                <a href="{{ url('/tutor/proyecto/' . $p->id) }}"
                                    class="inline-flex items-center gap-1 bg-[#003360] text-white px-3 py-1.5 rounded text-xs font-bold uppercase tracking-wider hover:bg-[#002244] transition-colors shadow-sm">
